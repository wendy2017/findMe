...
export const colorAttributes = [
  ...
  { colorName: "eyePupilColor", name: "Eye Pupil color", range: COLOR_RANGE },
  {
    colorName: "eyePupilBeforeColor",
    name: "Eyepupil Before color",
    range: COLOR_RANGE,
  },
  { colorName: "birthmarkColor", name: "Birth Mark color", range: COLOR_RANGE },
  { colorName: "earColor", name: "Ear color", range: COLOR_RANGE },
  {
    colorName: "mouthToungueColor",
    name: "Mouth Toungue color",
    range: COLOR_RANGE,
  },

  { colorName: "legColor", name: "Leg color", range: COLOR_RANGE },
  { colorName: "footColor", name: "Foot color", range: COLOR_RANGE },
];
